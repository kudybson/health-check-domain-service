...
alter table ADDRESS modify ADDRESS_ID Number(19);
alter table DEPARTMENT modify DEPARTMENT_ID Number(19);
alter table PRESCRIPTION modify PRESCRIPTION_ID Number(19);
alter table RATING modify RATING_ID Number(19);
alter table REFERRAL modify REFERRAL_ID Number(19);
alter table SCHEDULE modify SCHEDULE_ID Number(19);
alter table TEST modify TEST_ID Number(19);
alter table TEST_RESULT modify TEST_RESULT_ID Number(19);
alter table TREATMENT modify TREATMENT_ID Number(19);
